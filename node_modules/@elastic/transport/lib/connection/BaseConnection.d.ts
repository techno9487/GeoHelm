...
import { ApiKeyAuth, BasicAuth, BearerAuth, HttpAgentOptions, UndiciAgentOptions, agentFn } from '@elastic/transport/types';
import { kStatus, kDiagnostic, kCaFingerprint } from '@elastic/transport/symbols';
