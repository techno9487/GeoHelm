import BaseConnectionPool, { ConnectionPoolOptions, GetConnectionOptions } from '@elastic/transport/pool/BaseConnectionPool';
import { Connection, ConnectionOptions } from '@elastic/transport/connection';
