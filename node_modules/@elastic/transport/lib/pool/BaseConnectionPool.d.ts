...
import { kCaFingerprint } from '@elastic/transport/symbols';
import { Connection, ConnectionOptions, BaseConnection } from '@elastic/transport/connection';
import { HttpAgentOptions, UndiciAgentOptions, agentFn, ApiKeyAuth, BasicAuth, BearerAuth, nodeFilterFn, nodeSelectorFn } from '@elastic/transport/types';
